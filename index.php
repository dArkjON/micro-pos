...
$json2 = file_get_contents('https://insight.bitcore.cc/api/addr/'.$wallet); 
...
echo '<div id="open"><h6>Payment Wallet : '.$wallet.'<br><br>... loading Details ...</h6></div>';
	...
	$json2 = file_get_contents('https://insight.bitcore.cc/api/addr/'.$wallet1); 
	$data2 = json_decode($json2);
	$addrStr = $data2->addrStr;
	$balance = $data2->balance;
	$unconfirmedBalance = $data2->unconfirmedBalance;
	...
	$json2 = file_get_contents('https://insight.bitcore.cc/api/addr/'.$wallet2); 
	$data2 = json_decode($json2);
	$addrStr = $data2->addrStr;
	$balance = $data2->balance;
	$unconfirmedBalance = $data2->unconfirmedBalance;
	...
	$json2 = file_get_contents('https://insight.bitcore.cc/api/addr/'.$wallet3); 
	$data2 = json_decode($json2);
	$addrStr = $data2->addrStr;
	$balance = $data2->balance;
	$unconfirmedBalance = $data2->unconfirmedBalance;
	...
	$json2 = file_get_contents('https://insight.bitcore.cc/api/addr/'.$wallet4); 
	$data2 = json_decode($json2);
	$addrStr = $data2->addrStr;
	$balance = $data2->balance;
	$unconfirmedBalance = $data2->unconfirmedBalance;
